 ...
 *  ExitMessage
 *
 *  Display this text whenever CHIRON exits.
 *-------------------------------------------------------------------
 */
void
ExitMessage()
{
    fprintf(stdout,"******************************************************\n");
    fprintf(stdout,"**       Thank You for using CHIRON v1.1.2          **\n");
    fprintf(stdout,"**                                                  **\n");
#ifndef REGISTERED
    fprintf(stdout,"** --   This is an UNREGISTERED copy of CHIRON --   **\n");
    fprintf(stdout,"**   For registration and licensing information     **\n");
#else
    fprintf(stdout,"**   If you have any questions or comments          **\n");
#endif
    fprintf(stdout,"**   contact the authors at the locations listed    **\n");
    fprintf(stdout,"**   below.                                         **\n");
    fprintf(stdout,"**                                                  **\n");
    fprintf(stdout,"******************************************************\n");
    fprintf(stdout,"**                                                  **\n");
    fprintf(stdout,"**               Cellar Door Software               **\n");
    fprintf(stdout,"**               10831 Montego Drive                **\n");
    fprintf(stdout,"**             San Diego, Ca, USA, 92124            **\n");
    fprintf(stdout,"**                                                  **\n");
    fprintf(stdout,"**       e-mail : mmull@electriciti.com             **\n");
    fprintf(stdout,"**                garyhski@aol.com                  **\n");
    fprintf(stdout,"******************************************************\n");
}
